...
namespace Gadgeteer.Modules.JernejK
{
    ...
    /// </summary>
    public class NextionDisplay : GTM.Module
    {
        ...
        // GTM.JernejK.NextionDisplay. This file will provide IntelliSense and documentation for the
        // interface and make it easier for developers to use the NextionDisplay module.        

        // Note: A constructor summary is auto-generated by the doc builder.
        /// <summary></summary>
        /// <param name="socketNumber">The socket that this module is plugged in to.</param>
        /// <param name="socketNumberTwo">The second socket that this module is plugged in to.</param>
        public NextionDisplay(int socketNumber, int socketNumberTwo)
        {
        ...
        /// <summary>
        /// Gets a value that indicates whether the button of the NextionDisplay is pressed.
        /// </summary>
        ...
        /// <summary>
        /// Represents the state of button of the <see cref="NextionDisplay"/>.
        /// </summary>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="NextionDisplay"/> object that raised the event.</param>
        /// <param name="state">The state of the button of the <see cref="NextionDisplay"/></param>
        public delegate void ButtonEventHandler(NextionDisplay sender, ButtonState state);

        /// <summary>
        /// Raised when the button of the <see cref="NextionDisplay"/> is pressed.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Raised when the button of the <see cref="NextionDisplay"/> is released.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="NextionDisplay"/> that raised the event.</param>
        /// <param name="buttonState">The state of the button.</param>
        protected virtual void OnButtonEvent(NextionDisplay sender, ButtonState buttonState)
        {
